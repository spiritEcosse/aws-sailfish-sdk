...
deploy_qml_files_to_device() {
    find . -mmin -3 -type f | grep "qml"
    ind . -mmin -3 -type f | grep ".cpp"
    ind . -mmin -3 -type f | grep ".h"
    if [[ $(find . -mmin -3 -type f | grep "qml") && ! $(find . -mmin -3 -type f | grep ".cpp" && find . -mmin -3 -type f | grep ".h") ]];
    then
