...
foxy_sever_libs() {
    system_prepare_ubuntu
    install_for_ubuntu uuid-dev libjsoncpp-dev cmake make g++ zlib1g-dev supervisor jq libpq-dev micro unzip nlohmann-json3-dev libcurl4-openssl-dev libboost-all-dev git curl xz-utils rsync sudo sshpass
    install_clang
    ls -lah
}
